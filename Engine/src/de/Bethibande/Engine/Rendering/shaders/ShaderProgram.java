...
public abstract class ShaderProgram {
    ...
    protected void loadVector2(int location, Vector2f vec) { GL20.glUniform2f(location, vec.x, vec.y); }
    ...
    private static int loadShader(String file, int type){
        ...
        if(GL20.glGetShaderi(shaderID, GL20.GL_COMPILE_STATUS )== GL11.GL_FALSE){
            Log.logError(GL20.glGetShaderInfoLog(shaderID, 500));
            Log.logError("Could not compile shader!");
            System.exit(-1);
        }
        return shaderID;
    }
