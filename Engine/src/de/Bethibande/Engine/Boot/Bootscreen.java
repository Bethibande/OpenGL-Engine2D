...
public class Bootscreen {
    ...
    private static final SpriteLoader loader = new SpriteLoader();
    ...
    public static void open() {
        Thread t = new Thread(() -> {
            ...
            Image engine = engine1.getSubimage(0, 0, engine1.getWidth(), engine1.getHeight());
    ...
    private static class SpriteLoader {
        ...
        @Getter
        private final HashMap<String, ImageIcon> sprites = new HashMap<>();
